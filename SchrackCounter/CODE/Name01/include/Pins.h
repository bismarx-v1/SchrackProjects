...
#ifndef PINS_H
  #define PINS_H
  #define IS_PROTOTYPE_LAYOUT 1

  #if IS_PROTOTYPE_LAYOUT
  // NAME      | DESC.

    // MAIN_BTN  | Schrack light switch; --debounced --pullup
    #define GPIO_BTN_MAIN 1

    // R_LED     | LEDs, Indication --debug
    #define GPIO_LED_R 11

    // G_LED     | LEDs, Indication --debug
    #define GPIO_LED_G 12

    // Y_LED     | LEDs, Indication --debug
    #define GPIO_LED_Y 13
    ...
    // CLOCK     | SPI clock; SD Card, MAX7219
    #define GPIO_SPI_CLOCK 17

    // MOSI      | SPI; SD Card, MAX7219
    #define GPIO_SPI_MOSI 14

    // cSelect0  | Chipselect for MAX7219; --defHigh
    #define GPIO_SPI_SEL_MAX 21

    // cSelect1  | Chipselect for SD Card; --defHigh
    #define GPIO_SPI_SEL_SDCARD 16

    // MODE_SW   | External switch, --unused
    #define GPIO_SW_MODE 41

    //  RESET_SW  | External switch, Time/Score reset
